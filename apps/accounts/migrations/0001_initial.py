    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('farmer', 'Éleveur'), ('veterinarian', 'Vétérinaire'), ('technician', 'Technicien'), ('cooperative_manager', 'Responsable coopérative'), ('admin', 'Administrateur')], default='farmer', max_length=25)),
